...
.directive('tmPagination',function(){
    return {
        ...
        template: '<div class="pagination-centered">' +
            ...
            '<li class="arrow" ng-class="{disabled: conf.currentPage == 1}" ng-click="prevPage()"><a href="">&laquo;</a></li>' +
            '<li ng-repeat="item in pageList track by $index" ng-class="{current: item == conf.currentPage, separate: item == \'...\'}" ' +
            'ng-click="changeCurrentPage(item)">' +
            '<a href="">{{ item }}</a>' +
            '</li>' +
            '<li class="arrow"  ng-class="{disabled: conf.currentPage == conf.numberOfPages}" ng-click="nextPage()"><a href="">&raquo;</a></li>' +
            '</ul>' +
