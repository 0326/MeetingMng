...
/**
 * FinishMeetingView entity. @author MyEclipse Persistence Tools
 */
@Entity
@Table(name = "finish_meeting_view", catalog = "meetingmngdatabase")
public class FinishMeetingView implements java.io.Serializable {
	...
	/** default constructor */
	public FinishMeetingView() {
	}

	/** minimal constructor */
	public FinishMeetingView(String meetingName, String meetingContent,
